...
function inferLegacyJobPhase(job, progressPreview = []) {
  ...
  for (let index = progressPreview.length - 1; index >= 0; index -= 1) {
    ...
    if (line.startsWith("starting grok") || line.startsWith("starting codex") || line.startsWith("thread ready") || line.startsWith("turn started")) {
      return "starting";
    }
    ...
    if (line.startsWith("grok error:") || line.startsWith("codex error:") || line.startsWith("failed:")) {
      return "failed";
    }
  }
